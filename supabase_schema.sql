...
INSERT INTO public.banners (title, subtitle, image_url, link_url, is_active, ordem) VALUES
('Sabor Lendário', 'Hamburgueres assados e defumados na brasa', 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?auto=format&fit=crop&w=800&q=80', '#cardapio', TRUE, 1)
ON CONFLICT DO NOTHING;

-- Seed de Hambúrgueres do Rancho
INSERT INTO public.produtos (id, categoria_slug, name, description, full_description, price, promo_price, badge, image_url, ingredients, estimated_time, is_featured, is_promo, is_active, sales_count) VALUES
('b0000000-0000-0000-0000-000000000001', 'burgers', 'Double Cowboy Burger', 'Dois smash burgers premium de 150g assados na grelha, cheddar duplo bem derretido, cebola caramelizada e molho barbecue rústico.', 'Dois smash burgers premium nobres de 150g cada, assados e defumados com lenha rústica de macieira, cobertos por fatias generosas de cheddar cremoso legítimo, cebola roxa caramelizada em açúcar mascavo e pão de brioche dourado na manteiga de garrafa caipira original.', 38.90, 34.90, 'MAIS PEDIDO', 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?auto=format&fit=crop&w=800&q=80', ARRAY['Pão de brioche assado na chapa', '300g Blend Angus Premium', 'Double Cheddar real', 'Cebola roxa caramelizada', 'Molho barbecue rústico artesanal'], '15-28 min', TRUE, TRUE, TRUE, 142),
('b0000000-0000-0000-0000-000000000002', 'burgers', 'Tex-Mex Picante', 'Blend artesanal temperado de 180g, queijo monterey jack fatiado, pimenta jalapeño frita, guacamole cremoso de fazenda e nachos.', 'Uma explosão mexicana nos campos gaúchos: blend suculento artesanal grelhado de 180g, coberto com o finíssimo queijo monterey jack importado, pimenta jalapeño crocante em rodelas, guacamole real verde feito na hora e flocos dourados de nachos moídos para extrema crocância.', 36.90, NULL, 'PICANTE', 'https://images.unsplash.com/photo-1594212699903-ec8a3eca50f5?auto=format&fit=crop&w=800&q=80', ARRAY['Pão australiano amanteigado', '180g Blend Premium Angus', 'Monterey Jack derretido', 'Pimenta jalapeño frita com ervas', 'Guacamole caseiro defumado', 'Nachos crocantes moídos'], '20-25 min', FALSE, FALSE, TRUE, 89),
('b0000000-0000-0000-0000-000000000003', 'combos', 'Combo Xerife do Rancho', '1 Double Cowboy + 1 Batata Frita Individual Rustica + 1 Coca-Cola Lata bem gelada com limão.', 'O banquete definitivo do deserto americano: nosso líder absoluto de vendas Double Cowboy Burger acompanhado por nossa porção tradicional de batatas fritas rústicas e crocantes temperadas com páprica mineira, mais uma lata refrescante de refrigerante com gás extra.', 56.90, 49.90, 'MELHOR PREÇO', 'https://images.unsplash.com/photo-1606755962773-d324e0a13086?auto=format&fit=crop&w=800&q=80', ARRAY['Double Cowboy Burger', 'Batata individual rústica de fazenda', 'Lata de Coca-Cola gelada '], '20-30 min', TRUE, TRUE, TRUE, 215),
('b0000000-0000-0000-0000-000000000004', 'sides', 'Batatas Rústicas Hank', 'Porção de batatas com corte rústico especial caseiro com tempero exclusivo de sal defumado de ervas e alecrim.', 'Nossa receita secreta que o mestre do fogo Seu Hank desenvolveu: batatas selecionadas de colheita própria, cortadas em gomos rústicos grossos, fritas em óleo limpo até a casquinha perfeita e temperadas com sal marinho defumado, alecrim fresco e páprica.', 22.90, NULL, 'RECEITA SEGRETA', 'https://images.unsplash.com/photo-1573080496219-bb080dd4f877?auto=format&fit=crop&w=800&q=80', ARRAY['100% Batata Asterix nacional', 'Sal marinho defumado rústico', 'Fios frescos de alecrim', 'Páprica defumada'], '10-15 min', FALSE, FALSE, TRUE, 120),
('b0000000-0000-0000-0000-000000000005', 'drinks', 'Sucos Naturais do Pomar', 'Sucos de Laranja ou Limão siciliano espremidos na hora com hortelã fresca e gelo.', 'Bebida rústica fresca para aliviar a sede dos dias escaldantes de poeira e chapa de fogo. Feito exclusivamente com frutas colhidas no pomar local, espremido na hora com raspas sutis, gelo de poço limpo e folhas selecionadas de hortelã.', 12.00, NULL, 'NATURAL', 'https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?auto=format&fit=crop&w=800&q=80', ARRAY['Fruta orgânica colhida de manhã', 'Gelo mineral puro', 'Folhas selecionadas de hortelã crespa'], '5-10 min', FALSE, FALSE, TRUE, 78)
